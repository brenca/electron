...
class OffscreenWindow : public gin_helper::TrackableObject<OffscreenWindow>,
 ...
 protected:
  OffscreenWindow(gin::Arguments* args, const gin_helper::Dictionary& options);
  ...
  void OnRendererResponsive(content::RenderProcessHost*) override;
  ...
  v8::Local<v8::Value> GetWebContentsView(v8::Isolate* isolate);
