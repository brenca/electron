...
void OsrHostView::AddChildWebContents(gin::Handle<WebContentsView> child) {
...
// static
gin_helper::WrappableBase* OsrHostView::New(gin::Arguments* args) {
  // Constructor call.
...
void OsrHostView::BuildPrototype(v8::Isolate* isolate,
  ...
  prototype->SetClassName(gin::StringToV8(isolate, "OsrHostView"));
...
void Initialize(v8::Local<v8::Object> exports,
  ...
  dict.Set("OsrHostView", gin_helper::CreateConstructor<OsrHostView>(
                              isolate, base::BindRepeating(&OsrHostView::New)));
}

}  // namespace

NODE_LINKED_MODULE_CONTEXT_AWARE(electron_browser_osr_host_view, Initialize)
